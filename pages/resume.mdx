...
<div className="designation-with-img">
    <div>
        ...
        <small>
            <i className="contact-icon fa-solid fa-location-pin"></i> From Lahore, LeeOne   
            <i className="contact-icon fa-solid fa-envelope"></i> [mohsinhayat104@gmail.com](mailto:sarmat@gappoev.ru)   
        </small>
    </div>
    <div className="resume-dp" alt="Sarmat's profile picture" />
</div>
